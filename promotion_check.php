...
// ✅ ไฟล์นี้ไม่จำกัดสิทธิ์ - ใครก็เข้าได้ (สำหรับตรวจสอบโค้ดโปรโมชั่นตอนจอง)
// ไม่ต้องเช็ค Superadmin เพราะเป็น API สำหรับหน้า booking

// ตรวจสอบว่าล็อกอินหรือไม่
if (!isset($_SESSION['user_id'])) {
    echo json_encode(['valid' => false, 'message' => 'กรุณาเข้าสู่ระบบก่อนใช้โปรโมชั่น']);
    exit;
}
